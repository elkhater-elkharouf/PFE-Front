...
export class AuthResetPasswordV2Component implements OnInit {
   ...
   */
  constructor(private recp:ActivatedRoute ,private r: Router ,private _coreConfigService: CoreConfigService, private _formBuilder: UntypedFormBuilder , private userService:UserService) {
    ...
    this.userService.resetPassword(this.resetPasswordData, this.token).subscribe(
      data => {
        alert("Password was changed successfully");
         this.r.navigate(['/pages/authentication/login-v2']);
      },
      error => {
   ...
   */
  ngOnInit(): void {
    this.recp.queryParamMap.subscribe(params => {
